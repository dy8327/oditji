...
class BusinessServiceImplAdditionalCoverageTest {
    ...
    void deliveryUpdateShouldSaveStatusAndNotifyMember() {
        ...
        ArgumentCaptor<DeliveryManageVO> deliveryCaptor =
                ArgumentCaptor.forClass(DeliveryManageVO.class);
    ...
    void productListShouldLoadOptionsOnlyForClothesAndShoes() {
        ...
        when(businessDAO.selectProductListCountByBusinessNo(10L, null))
                .thenReturn(3);
        ...
        assertEquals(
                3,
                service.getProductListCountByBusinessNo(10L, " "));
    ...
    void eventQueriesAndExtensionShouldCoverSuccessAndValidation() {
        ...
        assertTrue(service.getEventListByBusinessNo(
                ...
                1,
                10).isEmpty());
        when(businessDAO.selectEventListCountByBusinessNo(10L, "검색"))
                .thenReturn(4);
        assertEquals(
                4,
                service.getEventListCountByBusinessNo(10L, " 검색 "));
    }
