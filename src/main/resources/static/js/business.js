document.addEventListener("DOMContentLoaded", function () {
    ...
    function initializeProductRowAccessibility() {
        ...
        const existingProductItems =
            productList.querySelectorAll(
                ".event-product-item"
            );


        existingProductItems.forEach(
            function (productItem, index) {
                ...
                if (productNameInput) {
                    ...
                    const productNameIndexMatch =
                        productNameInput.id.match(
                            /^productName_(\d+)$/
                        );
                    ...
                    if (productNameIndexMatch) {
                        ...
                        productRowSequence =
                            Math.max(
                                productRowSequence,
                                Number(productNameIndexMatch[1]) + 1
                            );
                ...
                if (discountInput) {
                    ...
                    if (!discountInput.id) {
                        ...
                        discountInput.id =
                            "productDiscountRate_" + index;

                    }


                    const discountIndexMatch =
                        discountInput.id.match(
                            /^productDiscountRate_(\d+)$/
                        );
        ...
        const productSectionLabel =
            productList.previousElementSibling;


        if (
            firstProductNameInput
            && productSectionLabel
            && productSectionLabel.tagName === "LABEL"
        ) {

            productSectionLabel.htmlFor =
                firstProductNameInput.id;
    ...
    document.addEventListener(
        ...
        function (event) {
            ...
            const discountRateId =
                "productDiscountRate_"
                + currentRowSequence;


            const productRowNumber =
            ...
            button.addEventListener(
                ...
                function () {
                    ...
                    const productNoInput =
                        currentProductItem.querySelector(
                            ".productNo"
                        );
    ...
    if (eventRegisterForm) {
        ...
        eventRegisterForm.addEventListener(
            ...
            function (event) {
                ...
                const productNos =
                    eventRegisterForm.querySelectorAll(
                        ".productNo"
                    );
