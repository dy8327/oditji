...
public class GoogleLoginController {
    ...
    public GoogleLoginController(GoogleLoginService googleLoginService, MemberPlatformService memberPlatformService, 
    ...
    public String googleLogin(HttpSession session, RedirectAttributes redirectAttributes) {
    ...
    public String googleCallback(
        ...
        try {
            ...
            if (result.isNewMember() || platformCount == 0) {
                savePendingSession(session, member, displayName);
    ...
    private void savePendingSession(HttpSession session, MemberSocialJoinVO member, String displayName) {
