...
public class SearchResultVO {
    ...
    public Long getContentNo() { return contentNo; }
    public void setContentNo(Long contentNo) { this.contentNo = contentNo; }
    public Long getTmdbId() { return tmdbId; }
    public void setTmdbId(Long tmdbId) { this.tmdbId = tmdbId; }
    public String getContentType() { return contentType; }
    public void setContentType(String contentType) { this.contentType = contentType; }
    public String getTitle() { return title == null || title.trim().isEmpty() ? "제목 없음" : title; }
    ...
    public String getMatchedPersonRole() { return matchedPersonRole; }
    public void setMatchedPersonRole(String matchedPersonRole) { this.matchedPersonRole = matchedPersonRole; }
    public List<OttPlatformVO> getPlatformList() { return platformList; }
    public void setPlatformList(List<OttPlatformVO> platformList) { this.platformList = platformList == null ? new ArrayList<OttPlatformVO>() : platformList; }
}
