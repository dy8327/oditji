...
<%-- reviewManage.jsp와 동일한 방식으로 currentTab을 관리한다. --%>
...
<div class="admin-wrap">
    ...
    <main class="main-content">
        ...
        <%-- 상단 통계 카드. reviewManage.jsp와 동일한 .member-stat-grid 컴포넌트를 재사용한다. --%>
        <div class="member-stat-grid">

            <a class="stat-card ${currentTab == 'all' ? 'active' : ''}"
               href="?tab=all">
                <span>전체 리뷰</span>
                <strong>${productReviewStats.totalCount}건</strong>
            </a>

            <a class="stat-card ${currentTab == 'report' ? 'active' : ''}"
               href="?tab=report">
                <span>신고 접수</span>
                <strong>${productReviewStats.reportCount}건</strong>
            </a>
        ...
        <section class="admin-content-box">
            ...
            <div class="toolbar">
                ...
                <form method="get"
                    ...
                    <label for="productReviewStatusFilter"
                           class="sr-only">
                        상태 필터
                    </label>

                    <select id="productReviewStatusFilter"
                            name="tab"
                            class="filter-select">
                    ...
                    <%-- 검색 기준 필터. --%>
                    <label for="productReviewSearchTypeFilter"
                           class="sr-only">
                        검색 기준
                    </label>

                    <select id="productReviewSearchTypeFilter"
                            name="searchType"
                            class="filter-select">
            ...
            <form id="reviewBulkForm" method="post" action="${pageContext.request.contextPath}/admin/productReview/bulk">
                                        ...
                                        <td>
                                            ...
                                            <div class="item-actions">
                                                ...
                                                <%-- 리뷰 내용이 길어도 팝업으로 전체 내용을 그대로 확인할 수 있다.
                                                     ...
                                                     data-* 속성으로 값을 전달한다.
                                                     [수정] reviewManage.jsp와 동일하게 row-detail-trigger를 붙여
                                                     모바일에서는 이 버튼만 남고 아래 승인/반려·삭제 버튼은 숨긴다. --%>
                                                <button type="button"
...
<div class="modal-overlay" id="reviewContentModal">
    ...
    <div class="modal-box modal-box-lg">
        ...
        <div class="target-info-box">
            ...
            <p><span>상품명</span><strong id="reviewContentTarget"></strong></p>
