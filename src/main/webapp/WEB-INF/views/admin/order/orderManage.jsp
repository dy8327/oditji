                                ...
                                <c:when test="${not empty refundList}">
                                    ...
                                    <c:forEach var="refund" items="${refundList}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-mobile-hide"><c:out value="${refund.contentTitle}"/></td>
                                            <td><c:out value="${refund.memberId}"/></td>
                                            <td class="col-mobile-hide"><c:out value="${refund.reason}"/></td>
                                            ...
                                            <td>
                                                <%--
                                                    ...
                                                    또한 환불 사유/반려 사유에 따옴표나 줄바꿈이 섞여도 onclick 인라인
                                                    문자열이 깨지지 않도록 data-* 속성으로 값을 전달한다.
                                                --%>
                                                <button type="button" class="btn btn-dark"
