...
<div class="business-wrap">
    ...
    <main class="main-content">
        ...
        <section class="form-panel">
            <h1 class="form-title">상품 수정 요청</h1>
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="submit-stack"><button class="btn btn-primary" type="submit">상품 수정 요청</button><a class="btn btn-dark" href="<%= contextPath %>/business/product/list">취소</a></div>
            </form>
        </section>
    </main>
</div>
