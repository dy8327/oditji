...
<div class="business-wrap">
    ...
    <main class="main-content">
        ...
        <section class="content-panel">
            <nav class="tab-menu"><a href="<%= contextPath %>/business/settlement/expected">정산 예정 금액</a><a href="<%= contextPath %>/business/settlement/complete">정산 완료 금액</a><a class="active" href="<%= contextPath %>/business/settlement/account">계좌 정보 관리</a></nav>
            <div class="summary-box"><p>은행명 : 국민은행</p><p>계좌번호 : 123456-78-901234</p><p>예금주 : 오디지사업자</p></div>
            <div class="btn-row"><a class="btn btn-primary" href="<%= contextPath %>/business/settlement/account-update">수정하기</a></div>
        </section>
    </main>
</div>
<footer class="footer">
