...
<div class="business-wrap">
    ...
    <main class="main-content">
        ...
        <section class="content-panel">
            <div class="toolbar"><input type="text" class="page-search" placeholder="이벤트명, 상태 검색"><div class="btn-row"><a class="btn btn-primary" href="<%= contextPath %>/business/event/register">등록 요청</a></div></div>
            <table class="data-table"><thead><tr><th>번호</th><th>이벤트명</th><th>이벤트 기간</th><th>상태</th><th>등록일</th><th>관리</th></tr></thead><tbody><tr><td>1</td><td>여름 굿즈 기획전</td><td>2026-07-01 ~ 2026-07-31</td><td><span class="status ok">진행중</span></td><td>2026-06-20</td><td><a class="btn btn-dark" href="<%= contextPath %>/business/event/update">수정 요청</a></td></tr><tr><td>2</td><td>인기 영화 굿즈 모음</td><td>2026-06-01 ~ 2026-06-30</td><td><span class="status waiting">승인 대기</span></td><td>2026-05-25</td><td><a class="btn btn-dark" href="<%= contextPath %>/business/approval/event-detail">승인 상태</a></td></tr></tbody></table>
            <div class="pagination"><a href="#">‹</a><a class="active" href="#">1</a><a href="#">2</a><a href="#">3</a><a href="#">›</a></div>
        </section>
    </main>
</div>
<footer class="footer">
