...
<div class="business-wrap">
    ...
    <main class="main-content">
        <a href="<%= contextPath %>/business/main" class="back-link">← 뒤로가기</a><h1 class="page-title">메시지함</h1>
        <section class="message-box"><div class="btn-row"><button class="btn btn-dark" type="button">받는 사람</button><button class="btn btn-dark" type="button">제목</button><button class="btn btn-dark" type="button">날짜</button></div><div class="message-content">메시지 내용</div><div class="btn-row" style="justify-content:flex-end;"><button class="btn btn-dark" type="button" onclick="history.back();">취소</button><button class="btn btn-primary" type="button">완료</button></div></section>
    </main>
</div>
<footer class="footer">
    <span>ODITJI</span>
